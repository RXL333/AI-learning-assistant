...
- 🖥️ 前端：`Vue 3 + Vue Router + Vite`
- ⚙️ 后端：`FastAPI + SQLAlchemy`
- 🗄️ 数据库：默认 `SQLite`，可切换 `MySQL`
...
1. 🗣️ 先在 `AI 问答` 中提问、解释、拆解知识点
2. 📝 再把问题沉淀到 `错题本` 或 `思维导图`
3. ✍️ 通过 `AI 出题` 做练习并记录薄弱点
